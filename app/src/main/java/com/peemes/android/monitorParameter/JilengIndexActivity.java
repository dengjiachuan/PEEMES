...
public class JilengIndexActivity extends AppCompatActivity {
    private String [] data = {"急冷区能量流","急冷区物质流"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        button_title_back.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent = new Intent(JilengIndexActivity.this, ParaweterMonitorActivity.class);
