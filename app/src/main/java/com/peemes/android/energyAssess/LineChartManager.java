...
public class LineChartManager {
    ...
    public static YAxis leftYAxis;            //左侧Y轴
    public static YAxis rightYAxis;           //右侧Y轴 自定义XY轴值
    public static Legend legend;              //图例
    public static LimitLine limitLine;        //限制线
...
//        description.setText("需要展示的内容");
     ...
     * @param color    曲线颜色
     */
    public static void showOneLineChart(List<Float> yData, String lineName, int color) {
     ...
     * @param colors    曲线颜色
     */
    public static void showMultiNormalLineChart(List<List<Float>> yDataList, List<String> lineNames, List<Integer> colors) {
     ...
     */
    public static void setXAxisData(float min, float max, int labelCount) {
     ...
     * @param labelCount x轴的分割数量
     */
    public static void setXAxisData(final List<String> xAxisStr, int labelCount) {
        xAxis.setLabelCount(labelCount, false);
     ...
     * @param labelCount
     */
    public static void setYAxisData(float max, float min, int labelCount) {
     ...
     */
    public static void setYAxisData(final List<String> yAxisStr, int labelCount) {
        xAxis.setLabelCount(labelCount, false);
        xAxis.setValueFormatter(new IAxisValueFormatter() {
            @Override
            public String getFormattedValue(float value, AxisBase axis) {
     ...
     * @param name
     */
    public static void setHighLimitLine(float high, String name, int color) {
        if (name == null) {
            name = "高限制线";
        }
     ...
     * @param name
     */
    public static void setLowLimitLine(float low, String name, int color) {
        if (name == null) {
            name = "高限制线";
        }
     ...
     * @param color    曲线颜色
     */
    public static void showLineChart(final List<EAFiveMinuteParameter> dataList, String name, int color) {
