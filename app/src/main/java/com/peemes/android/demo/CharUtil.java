...
public class CharUtil {
    ...
    //一条曲线
    public CharUtil(LineChart mLineChart, String name, int color) {
    ...
    //多条曲线
    public CharUtil(LineChart mLineChart, List<String> names, List<Integer> colors) {
        this.lineChart = mLineChart;
